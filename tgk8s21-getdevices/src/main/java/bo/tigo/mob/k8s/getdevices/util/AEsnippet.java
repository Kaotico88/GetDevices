...
public class AEsnippet {
    ...
    public static boolean isMsisdnOK(String msisdn, String codCountry, int msisdnSize) {
        if (codCountry == null || codCountry.trim().isEmpty()) {
            return msisdn.matches("\\d{" + msisdnSize + "}");
        }
        return msisdn.matches("\\+?(" + codCountry + ")(\\d{" + msisdnSize + "})");
    }
    ...
    /**
     * Devuelve un Timestamp como un LocalDateTime.
     * 
     * @param timeStamp Timestamp a transformar
    ...
    /**
     * Devuelve un Timestamp como un ZonedDateTime.
     * 
     * @param timeStamp Timestamp a transformar
     * @param zoneId    (Ej. '-04:00', '+05:00', 'America/Sao_Paulo')
     * @return ZonedDateTime
     */
    public static ZonedDateTime timestampToZonedDateTime(Timestamp timestamp, String zoneId) {
        ...
        return localDateTimeNoTimeZone.atZone(ZoneId.of(zoneId));
    }

    /**
     * Devuelve un Timestamp como un ZonedDateTimeString.
     * 
     * @param timeStamp Timestamp a transformar
     * @param zoneId    (Ej. '-04:00', '+05:00', 'America/Sao_Paulo')
     * @param pattern   formato del texto (Ej. yyyy-MM-dd'T'HH:mm:ss.SSSXXX)
     * @return ZonedDateTimeString
     */
    public static String timestampToZonedDateTimeString(Timestamp timestamp, String zoneId, String pattern) {
        if (pattern == null || pattern.trim().isEmpty()) {
            return timestampToZonedDateTime(timestamp, zoneId).toString();
        }
        return timestampToZonedDateTime(timestamp, zoneId).format(DateTimeFormatter.ofPattern(pattern));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("zonedDateTime8: " + zonedDateTime.format(DateTimeFormatter.ofPattern(pattern)));
        pattern = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
        System.out.println("zonedDateTime9: " + zonedDateTime.format(DateTimeFormatter.ofPattern(pattern)));
        pattern = "yyyy-MM-dd'T'HH:mm:ss.SSSZZZZ";
        System.out.println("zonedDateTime10: " + zonedDateTime.format(DateTimeFormatter.ofPattern(pattern)));
        pattern = "yyyy-MM-dd'T'HH:mm:ss.SSSXXX";
        System.out.println("zonedDateTime11: " + zonedDateTime.format(DateTimeFormatter.ofPattern(pattern)));
        System.out.println("----");
        ...
        System.out.println("----");
        zonedDateTime = ZonedDateTime.parse("2020-08-24T21:49:31.000+01:00");
        ...
        System.out.println("zonedDateTime: " + zonedDateTime.format(DateTimeFormatter.ISO_OFFSET_DATE_TIME));
        pattern = "yyyy-MM-dd'T'HH:mm:ss.SSSZZZZ";
        System.out.println("zonedDateTime: " + zonedDateTime.format(DateTimeFormatter.ofPattern(pattern)));
        pattern = "yyyy-MM-dd'T'HH:mm:ss.SSSXXX";
        System.out.println("zonedDateTime: " + zonedDateTime.format(DateTimeFormatter.ofPattern(pattern)));
        System.out.println("----");
        System.out.println("+59170700001: " + isMsisdnOK("+59170700001", "591", 8));
        System.out.println("+59170700001: " + isMsisdnOK("+59170700001", "592", 8));
    }
}
