 ...
 * *************************************************************************
 */
package bo.tigo.mob.k8s.getdevices.util.exception.response;
...
import bo.tigo.mob.k8s.getdevices.util.exception.response.custom.CustomBadRequestException;
import bo.tigo.mob.k8s.getdevices.util.exception.response.custom.CustomNotFoundException;
import bo.tigo.mob.k8s.getdevices.util.exception.response.custom.CustomRuntimeException;
import bo.tigo.mob.k8s.getdevices.util.exception.response.custom.XErrorResponse;
